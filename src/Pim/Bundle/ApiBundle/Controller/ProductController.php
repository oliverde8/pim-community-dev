...
class ProductController
{
    ...
    public function createAction(Request $request)
    {
        ...
        $data = $this->createIdentifierProductValue($data);
    ...
    /**
     * Creates the identifier product value with the same identifier as the value of the identifier property.
     ...
     * @return array
     */
    protected function createIdentifierProductValue(array $data)
    {
