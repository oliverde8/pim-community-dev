...
class ErrorListProductIntegration extends AbstractProductTestCase
{
    ...
    public function testSearchFormatIsNotValid()
    {
        ...
        $this->assert($client, 'Structure of attribute "a_localized_and_scopable_text_area" should respect this structure: {"a_localized_and_scopable_text_area":[{"operator": "my_operator", "value": "my_value"}]}');
    }
